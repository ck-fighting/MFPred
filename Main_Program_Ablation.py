...
import os
from Model import GRU_ResNet
from Data_Create import GP_GCN_new2

PATH_Model = 'Trained_model/ablation/GCN'
...
Train_Data, Train_Label = GP_GCN_new2.train_data()#获取RNA碱基信息
Test_Data, Test_Label = GP_GCN_new2.test_data()#获取RNA标签信息
model = GRU_ResNet.model_mix()
